...
def chapter3():
    return(f"'The power is back!' {character()} shouted, and lights flickered to life from all directions. In the center, a commanding figure was illuminated - it was the head of ProRail, working alongside the CrowdLogic team to address the crowd congestion issue. However, he couldn't revel in the joy of the moment -- his lovers, {luca.character()}, {jelle.character()},{rachna.character()}, {karolina.character()}, and {alexia.character()} were still missing. ")
