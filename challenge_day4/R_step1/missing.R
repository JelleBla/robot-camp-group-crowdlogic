...
json_data <- jsonlite::fromJSON("robot-camp-group-crowdlogic/challenge_day4/fulldata/data1.json")
...
writeLines(json_text, "robot-camp-group-crowdlogic/challenge_day4/fulldata/data2.json")
